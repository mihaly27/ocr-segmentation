...
def normalized(row: dict[str, Any], root: Path, prefix: str) -> dict[str, Any]:
    ...
    return {
        ...
        "image_path": str(path),
        # The frozen historical runner stringifies this field before json.loads.
        # Store canonical JSON text here rather than a native JSONL list, or the
        # intermediate Python repr would contain single quotes and fail parsing.
